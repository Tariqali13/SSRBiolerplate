...
const ProPlan = props => {
  ...
  return (
    <div className="col-md-3 col-12  margin-mobiled">
      <div className="payment-plan featured-plan">
        <div className="payment-plan-header">
          <img src={`${CDN_URL}/assets/pp-2-svg.png`} className="plan-img" />
          <h3>Pro</h3>
          <h4>Most Popular</h4>
          <div className="price">
          ...
          <Link
            onClick={() => {
              ...
              localStorage.setItem("price", "Pro Plan");
              localStorage.setItem("planId", props.pro_planId);
              localStorage.setItem("billed", props.billed);
            }}
            to="/signup"
            title="Sign Up"
            className="btn-orange active"
          >
            Choose Plan
          </Link>
        </div>
        <div className="plan-features">
          <ul>
            ...
            <li>
              ...
              <LightTooltip
                title="Includes Google Analytics, Mailchimp, ConvertKit, Facebook pixels and more "
                placement="top"
              >
                <img
                  src={`${CDN_URL}/assets/info.svg`}
            ...
            <li>
              Automation*
              <LightTooltip
                title="Create automated workflows for both prospects and customers. Automate student welcome and completion emails"
                placement="top"
              >
                <img
                  src={`${CDN_URL}/assets/info.svg`}
            ...
            <li>
              ...
              <LightTooltip
                title="Grow your list up to 25,000 contacts to give value and sell more."
                placement="top"
              >
                <img
                  src={`${CDN_URL}/assets/info.svg`}
