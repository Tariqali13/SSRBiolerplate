        ...
        <div className="row h-100">
          <div className="col-md-6 my-auto">
            <div className="starting-widget">
              ...
              <p>
                Create and sell online courses, offer digital and physical
                products, construct your sales funnels and build an amazing
                website - at Vonza! The only platform of it’s kind in the world.
              </p>
